...
$$\begin{aligned} D_{11} &= \sum_i A_{bi} Z_{bni}^2 E_b v_{bi} + \sum_j A_{bj} Z_{snj}^2 E_{sj} v_{sj} + \sum_k A_{bk} Z_{bnk}^2 E_b v_{bk} \qquad (K.1) \\ D_{22} &= \sum_i A_{bi} Z_{byi}^2 E_b v_{bi} + \sum_j A_{bj} Z_{syj}^2 E_{sj} v_{sj} + \sum_k A_{bk} Z_{byk}^2 E_b v_{bk} \qquad (K.2) \\ D_{12} &= \sum_i A_{bi} Z_{bni} Z_{byi} E_b v_{bi} + \sum_j A_{bj} Z_{snj} Z_{syj} E_{sj} v_{sj} + \sum_k A_{bk} Z_{bnk} Z_{byk} E_b v_{bk} \qquad (K.3) \\ D_{13} &= \sum_i A_{bi} Z_{bni} E_b v_{bi} + \sum_j A_{bj} Z_{snj} E_{sj} v_{sj} + \sum_k A_{bk} Z_{bnk} E_b v_{bk} \qquad (K.4) \\ D_{23} &= \sum_i A_{bi} Z_{byi} E_b v_{bi} + \sum_j A_{bj} Z_{syj} E_{sj} v_{sj} + \sum_k A_{bk} Z_{byk} E_b v_{bk} \qquad (K.5) \\ D_{33} &= \sum_i A_{bi} E_b v_{bi} + \sum_j A_{bj} E_{sj} v_{sj} + \sum_k A_{bk} E_b v_{bk} \qquad (K.6) \end{aligned}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_K_1_6" -->
...
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_K_7_9" -->
