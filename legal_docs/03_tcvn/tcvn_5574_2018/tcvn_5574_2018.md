...
&nbsp;&nbsp;&nbsp;&nbsp;\- $M_{u}$ và $M'_u$ là các mô men giới hạn mà tiết diện có thể chịu được.

Các mô men $M_{u}$ và $M'_u$ được xác định theo các công thức:
...
<a id="formula-85"></a>
$$\epsilon_{bt,max}$≤ $\epsilon_{bt,u} \tag{85}$$
...
&nbsp;&nbsp;&nbsp;&nbsp;\- $\alpha$ là hệ số quy đổi cốt thép về bê tông, α = $E_{s}$/$E_{b}$;
