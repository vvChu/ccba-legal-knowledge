...
<a id="formula-107"></a>
$$q_{sw,1} = \frac{R_{sw} A_{sw,1}}{s_w} \tag{107}$$
...
<a id="formula-108"></a>
$$C_{sw} = \delta \cdot C \tag{108}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_108" -->

&nbsp;&nbsp;&nbsp;&nbsp;\- $\delta$ là hệ số, kể đến tỷ lệ các cạnh của tiết diện ngang:
...
<p align="center"><strong>Hình 15 (kết thúc)</strong></p>
...
$$x(y)_0 = \frac{\sum L_i x_i (y_i)_0}{\sum L_i} \tag{135}$$
