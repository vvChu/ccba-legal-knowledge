...
$$\begin{aligned} &\text{Khi } 0 \le \varepsilon_b \le \varepsilon_{b1}: & \sigma_b &= E_b \varepsilon_b \tag{8} \\ &\text{Khi } \varepsilon_{b1} < \varepsilon_b < \varepsilon_{b0}: & \sigma_b &= \left[ \left(1 - \frac{\sigma_{b1}}{R_b}\right) \frac{\varepsilon_b - \varepsilon_{b1}}{\varepsilon_{b0} - \varepsilon_{b1}} + \frac{\sigma_{b1}}{R_b} \right] R_b \tag{9} \\ &\text{Khi } \varepsilon_{b0} \le \varepsilon_b \le \varepsilon_{b2}: & \sigma_b &= R_b \tag{10} \end{aligned}$$
...
$$\begin{aligned} &\text{Khi } 0 \le \varepsilon_b \le \varepsilon_{b1} \text{ (với } \varepsilon_{b1} = R_b/E_{b,\text{red}}): & \sigma_b &= E_{b,\text{red}}\varepsilon_b \tag{11} \\ &\text{Khi } \varepsilon_{b1} \le \varepsilon_b \le \varepsilon_{b2}: & \sigma_b &= R_b \tag{12} \end{aligned}$$
...
$$5 \left( 1 - \frac{\sigma_m}{R_b} \right) & \quad \text{khi} \quad 0.75 R_b < \sigma_m \le R_b \\
1 - \frac{\sigma_t}{2 R_{bt}} & \quad \text{khi} \quad 0 < \sigma_t \le R_{bt}
\end{align*}$$
