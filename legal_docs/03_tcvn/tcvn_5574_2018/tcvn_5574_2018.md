...
$$\begin{align} |\varepsilon_{b,\max}| &\le \varepsilon_{b,u} \qquad (70) \\ \varepsilon_{s,\max} &\le \varepsilon_{s,u} \qquad (71) \end{align}$$
...
$$\begin{align}
M_x &= D_{11} \frac{1}{r_x} + D_{13} \epsilon_0 \qquad (81) \\
N &= D_{13} \frac{1}{r_x} + D_{33} \epsilon_0 \qquad (82)
\end{align}$$
...
$$\begin{cases} 1 & \text{khi } \sigma_m \le 0,75 R_b \\ 5 \left( 1 - \frac{\sigma_m}{R_b} \right) & \text{khi } 0,75 R_b < \sigma_m \le R_b \end{cases}$$
