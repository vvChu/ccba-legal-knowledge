...
$$\begin{aligned} &\text{- Khi } 0 \le \varepsilon_b \le \varepsilon_{b1}: \\ &\qquad\qquad \sigma_b = E_b \varepsilon_b \qquad (8) \\[6pt] &\text{- Khi } \varepsilon_{b1} < \varepsilon_b < \varepsilon_{b0}: \\ &\qquad\qquad \sigma_b = \le ft[ \le ft(1 - \frac{\sigma_{b1}}{R_b}\right) \frac{\varepsilon_b - \varepsilon_{b1}}{\varepsilon_{b0} - \varepsilon_{b1}} + \frac{\sigma_{b1}}{R_b} \right] R_b \qquad (9) \\[6pt] &\text{- Khi } \varepsilon_{b0} \le \varepsilon_b \le \varepsilon_{b2}: \\ &\qquad\qquad \sigma_b = R_b \qquad (10) \end{aligned}$$
...
$$<!-- FIGURE: hinh_1|Các biểu đồ biến dạng của bê tông khi nén -->$$
<!-- formula_id: "F_TCVN_5574_2018_RID15" -->
...
$$\begin{aligned} &\text{- Khi } 0 \le \varepsilon_b \le \varepsilon_{b1} \text{ (với } \varepsilon_{b1} = R_b/E_{b,\text{red}}): \\ &\qquad\qquad \sigma_b = E_{b,\text{red}}\varepsilon_b \qquad (11) \\[6pt] &\text{- Khi } \varepsilon_{b1} \le \varepsilon_b \le \varepsilon_{b2}: \\ &\qquad\qquad \sigma_b = R_b \qquad (12) \end{aligned}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_11_12" -->

&nbsp;&nbsp;\- Khi 0 ≤ $_{b}$ ≤ $_{b1}$ (với $_{b1}$ = $R_{b}$/$E_{b,red}$)
...
$$<!-- FIGURE: hinh_2|Các biểu đồ biến dạng của cốt thép khi kéo -->$$
<!-- formula_id: "F_TCVN_5574_2018_RID21" -->
...
$$\begin{aligned} &\text{Khi } 0 < \varepsilon_s < \varepsilon_{s0} : & \sigma_s = \varepsilon_s E_s \tag{17} \\ &\text{Khi } \varepsilon_{s0} \le \varepsilon_s \le \varepsilon_{s2} : & \sigma_s = R_s \tag{18} \end{aligned}$$
...
$$\begin{aligned} &\text{Khi } 0 < \varepsilon_s < \varepsilon_{s1} : & \sigma_s = \varepsilon_s E_s \tag{19} \\ &\text{Khi } \varepsilon_{s1} \le \varepsilon_s \le \varepsilon_{s0} : & \sigma_s = \left[ \left(1 - \frac{\sigma_{s1}}{R_s}\right)\frac{\varepsilon_s - \varepsilon_{s1}}{\varepsilon_{s0} - \varepsilon_{s1}} + \frac{\sigma_{s1}}{R_s} \right] R_s \tag{20} \\ &\text{Khi } \varepsilon_{s0} \le \varepsilon_s \le \varepsilon_{s2} : & \sigma_s = \left[ \left(\frac{\sigma_{s2}}{R_s} - 1\right)\frac{\varepsilon_s - \varepsilon_{s0}}{\varepsilon_{s2} - \varepsilon_{s0}} + 1 \right] R_s \tag{21} \end{aligned}$$
...
<!-- DIAGRAM: word/media/image34.png -->
...
<!-- DIAGRAM: word/media/image42.png -->
...
&nbsp;&nbsp;&nbsp;&nbsp;\- $M_{u}$ và $M'_u
<!-- formula_id: "F_TCVN_5574_RID74" -->$ là các mô men giới hạn mà tiết diện có thể chịu được.

Các mô men $M_{u}$ và $M'_u
<!-- formula_id: "F_TCVN_5574_RID76" -->$ được xác định theo các công thức:
...
& A_s', A_s, A_b
\end{aligned}$$
<!-- formula_id: "F_TCVN_5574_2018_RID86" -->


<!-- DIAGRAM: word/media/image55.png -->
...
<!-- DIAGRAM: word/media/image56.png -->
...
$$\begin{aligned}
M_x &= \sum_i \sigma_{bi} A_{bi} Z_{bxi} + \sum_j \sigma_{sj} A_{sj} Z_{syj} \tag{59} \\
M_y &= \sum_i \sigma_{bi} A_{bi} Z_{byi} + \sum_j \sigma_{sj} A_{sj} Z_{syj} \tag{60} \\
N &= \sum_i \sigma_{bi} A_{bi} + \sum_j \sigma_{sj} A_{sj} \tag{61}
\end{aligned}$$
...
$$First eq: \varepsilon_{bx} (epsilon sub bx), \varepsilon_0 , Z_{bxj} , Z_{byj} .
Second eq: \varepsilon_{sj} (epsilon sub sj), \varepsilon_0 , Z_{sxj} , Z_{syj} .$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_62" -->

&nbsp;&nbsp;\- Các quan hệ giữa ứng suất và biến dạng tương đối của bê tông và của cốt thép:


$$\begin{aligned} \nu_{bi} &= \frac{\sigma_{bi}}{E_{bi} \varepsilon_{bi}} \tag{64} \\ \nu_{sj} &= \frac{\sigma_{sj}}{E_{sj} \varepsilon_{sj}} \tag{65} \end{aligned}$$
...
$$Top: v_{bi} = \frac{\sigma_{bi}}{E_b \varepsilon_{bi}}
Bottom: v_{sj} = \frac{\sigma_{sj}}{$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_68" -->
...
$$\begin{align} |\varepsilon_{b,\max}| &\le \varepsilon_{b,u} \tag{70} \\ \varepsilon_{s,\max} &\le \varepsilon_{s,u} \tag{71} \end{align}$$
...
$$\begin{align}
&M_x = D_{11} \frac{1}{r_x} + D_{12} \frac{1}{r_y} + D_{13} \varepsilon_0 \tag{72} \\
&M_y = D_{12} \frac{1}{r_x} + D_{22} \frac{1}{r_y} + D_{23} \varepsilon_0 \tag{73} \\
&N = D_{13} \frac{1}{r_x$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_72" -->

Các đặc trưng độ cứng $D_{ij}$ (i, j = 1, 2, 3) trong hệ các phương trình từ (72) đến (74) được xác định theo các công thức:


$$\begin{aligned} D_{11} &= \sum_i A_{bi} Z_{bi}^2 E_b \nu_{bi} + \sum_j A_{sj} Z_{sj}^2 E_{sj} \nu_{sj} \tag{75} \\ D_{22} &= \sum_i A_{bi} Y_{bi}^2 E_b \nu_{bi} + \sum_j A_{sj} Y_{sj}^2 E_{sj} \nu_{sj} \tag{76} \\ D_{12} &= \sum_i A_{bi} Z_{bi} Y_{bi} E_b \nu_{bi} + \sum_j A_{sj} Z_{sj} Y_{sj} E_{sj} \nu_{sj} \tag{77} \\ D_{13} &= \sum_i A_{bi} Z_{bi} E_b \nu_{bi} + \sum_j A_{sj} Z_{sj} E_{sj} \nu_{sj} \tag{78} \\ D_{23} &= \sum_i A_{bi} Y_{bi} E_b \nu_{bi} + \sum_j A_{sj} Y_{sj} E_{sj} \nu_{sj} \tag{79} \\ D_{33} &= \sum_i A_{bi} E_b \nu_{bi} + \sum_j A_{sj} E_{sj} \nu_{sj} \tag{80} \end{aligned}$$
...
$$\begin{align}
M_x &= D_{11} \frac{1}{r_x} + D_{13} \epsilon_0 \tag{81} \\
N &= D_{13} \frac{1}{r_x} + D_{33} \epsilon_0 \tag{82}
\end{align}$$
...
$$\begin{aligned}
M_x &= D_{11} \frac{1}{r_x} + D_{13} \varepsilon_0 \tag{83} \\
0 &= D_{13} \frac{1}{r_x} + D_{33} \varepsilon_0 \tag{84}
\end{aligned}$$
...
$$\begin{aligned}
\varepsilon_{b,u} &= \varepsilon_{b2} - (\varepsilon_{b2} - \varepsilon_{b0}) \frac{\varepsilon_1}{\varepsilon_2} \tag{86} \\
\varepsilon_{bt,u} &= \varepsilon_{bt2} - (\varepsilon_{bt2} - \varepsilon_{bt0}) \frac{\varepsilon_1}{\varepsilon_2} \tag{87}
\end{aligned}$$
...
<!-- DIAGRAM: word/media/image67.png -->
...
$$So the LaTeX is: `Q_b = \frac{\varphi_{b2} R_{bt} b h_0^2}{C} \tag{90}
...
<a id="formula-97"></a>
$$Q_b = \frac{\varphi_{b2} R_{bt} b h_0^2}{C} \tag{97}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_97" -->

và lấy giá trị này có kể đến các điều kiện giới hạn như đối với công thức (90).

Bước cốt thép ngang kể đến trong tính toán (tính trên $h_{0}$) $\frac{s_w}{h_c}$ không được lớn hơn giá trị $\frac{s_{w,\text{max}}}{h_0}$ với $\frac{s_{w,\text{max}}}{h_0}$ được xác định theo công thức:


<a id="formula-98"></a>
$$s_{w,max} = \frac{\varphi_{b4} R_{bt} b h_0^2}{Q} \tag{98}$$
...
$$5 \le ft( 1 - \frac{\sigma_m}{R_b} \right) & \quad \text{khi} \quad 0.75 R_b < \sigma_m \le q R_b \\
1 - \frac{\sigma_t}{2 R_{bt}} & \quad \text{khi} \quad 0 < \sigma_t \le q R_{bt}
\end{align*}$$
...
<!-- DIAGRAM: word/media/image76.png -->
...
<!-- DIAGRAM: word/media/image78.png -->
...
\delta = { \frac { Z _ { 1 } } { 2 Z _ { 2 } + Z _ { 1 } } } \tag{ 1 0 9 }$$
...
$$I will wrap it in an equation environment or just use \tag. The prompt asks for "clean KaTeX LaTeX syntax".
T_{sw,1} = q_{sw,1} \delta Z_1 Z_2 \tag{112}` is a good standard representation.
Or using `\begin{equation} ... \tag{112} \end{equation}`.
Given the instruction "If it contains formula number(s) like (15) or (16), include them using \tag{...} or \qquad (...)", I will use$$
...
$$T \le q T_0 \sqrt{1 - \le ft( \frac{M}{M_0} \right)^2} \qquad (114)$$
...
$$T \le q T_0 \le ft( 1 - \frac{Q}{Q_0} \right) \tag{115}$$
...
$$N \le q \psi R_{b,loc} A_{b,loc} \tag{116}$$
...
<!-- DIAGRAM: word/media/image92.png -->
...
<!-- DIAGRAM: word/media/image97.png -->
...
<!-- DIAGRAM: word/media/image98.png -->
...
$$\begin{aligned}
&\text{c) } L_x, L_y, \frac{h_0}{2} \\
&\text{d) } L_{sw,x}, L_{sw,y}, \frac{h_0}{2}
\end{aligned}$$
<!-- formula_id: "F_TCVN_5574_2018_RID144" -->
...
<!-- DIAGRAM: word/media/image100.png -->
...
<!-- DIAGRAM: word/media/image103.png -->
...
$$\frac{F}{F_{b,u}} + \frac{M}{M_{b,u}} \le q 1 \tag{129}$$
...
$$\frac{M_x}{M_{bx,u} + M_{swx,u}} + \frac{M_y}{M_{by,u} + M_{swy,u}} \le q 0,5 \frac{F}{F_{b,u} + F_{sw,u}}$$
...
$$So the string should be: `W_{bx(y)} = \frac{I_{bx(y)}}{x(y)_{\max}} \tag{134}` or `W_{bx(y)} = \frac{I_{bx(y)}}{x(y)_{max}} \tag{134}`. I will use `\max` for better typography.
...
<!-- DIAGRAM: word/media/image112.png -->
...
<!-- DIAGRAM: word/media/image113.png -->
...
$$\begin{gather}
(M_{x,u} - M_x)(M_{y,u} - M_y) - M_{xy}^2 \ge 0 \tag{137} \\
M_{x,u} \ge M_x \tag{138} \\
M_{y,u} \ge M_y \tag{139} \\
M_{xy,u} \ge M_{xy} \tag{140}
\end{gather}$$
...
$$\frac { Q _ { x } } { Q _ { x , u } } + \frac { Q _ { y } } { Q _ { y , u } } . . \le q 1 \tag{ 143 }$$
...
<!-- DIAGRAM: word/media/image116.png -->
...
$$\begin{align}
(N_{x,u} - N_x)(N_{y,u} - N_y) - N_{xy,u}^2 \ge 0 \tag{147} \\
N_{x,u} \ge N_x \tag{148} \\
N_{y,u} \ge N_y \tag{149} \\
N_{xy,u} \ge N_{xy} \tag{150}
\end{align}$$
...
$$Formula: M_{cr} = R_{bt,ser} W_{pl} \pm N e_0 .$$
...
<!-- DIAGRAM: word/media/image119.png -->
...
$$W_{red} = \frac{I_{red}}{y_t} \tag{160}
e_x = \frac{W_{red}}{A_{red}} \tag{161}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_160" -->
...
<!-- DIAGRAM: word/media/image128.png -->
...
$$\sigma_s = \le ft[ \frac{M(h_0 - y_c)}{I_{red}} \pm \frac{N}{A_{red}} \right] \alpha_{s1} \tag{172}$$
...
$$f_m = \int_0^L \overline{M}_x \le ft( \frac{1}{r} \right)_x dx \tag{178}$$
...
$$f_m = \frac{L}{12n^2} \le ft\{ \le ft(\frac{1}{r}\right)_{sup, L} + \le ft(\frac{1}{r}\right)_{sup, r} + 6 \sum$$
...
$$f_m = sL^2 \le ft( \frac{1}{r} \right)_{\text{max}} \tag{180}$$
...
$$\varphi_{crc} = \frac{3 E_b I_{red}}{M_x} \le ft( \frac{1}{r} \right)_x \tag{183}$$
...
$$\[ \le ft(\frac{1}{r}\right) = \le ft(\frac{1}{r}\right)_1 + \le ft(\frac{1}{r}\right)_2 \tag{185} \]
\[ \le ft(\frac{1}{r}\right) = \le ft(\$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_185" -->

&nbsp;&nbsp;\- Đối với các đoạn cấu kiện có vết nứt trong vùng chịu kéo:


$$\le ft(\frac{1}{r}\right) = \le ft(\frac{1}{r}\right)_1 - \le ft(\frac{1}{r}\right)_2 + \le ft(\frac{1}{r}\right)_3$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_185" -->
...
<a id="formula-187"></a>
$$\le ft(\frac{1}{r}\right) = \frac{M}{D} \tag{187}$$
...
E_{b1}=E_{b,r}=\frac{E_{b}}{1+\varphi_{b,cr}}\tag{192}$$
...
<!-- DIAGRAM: word/media/image158.png -->
...
$$x_m = h_0 \le ft(\sqrt{\le ft(\mu_s \alpha_{s2}+\mu'_s \alpha_{s1}\right)^2+2 \le ft(\mu_s \alpha_{s2}+\mu'_s \alpha_{s1}\frac{a'}{h_0}\right)}-\le ft(\mu_s \alpha_{s2}+\mu'_s \alpha_{s1}\right)\right) \tag{196}
...
$$x_m = h_0 \le ft( \sqrt{(\mu_s \alpha_{s2} + \mu'_s \alpha_{s1} + \mu'_f)^2 + 2 \le ft( \mu_s \alpha_{s2} + \mu'_s \alpha_{s1} \frac{a'}{h_0} + \mu'_f \frac{h'_f}{2h_0} \right)} - (\mu_s \alpha_{s2} + \mu'_s \alpha_{s1} + \mu'_f) \right) \tag{197}$$
...
$$\Delta \sigma_{sp1} = \le ft(0,22\frac{\sigma_{sp}}{R_{s,n}} - 0,1\right)\sigma_{sp} \tag{209}$$
...
$$\Delta \sigma_{sp7} = \sigma_{sp} \le ft(1 - \frac{1}{e^{\omega x + \delta \theta}}\right)$$
...
$$\Delta \sigma_{sp6} = \frac{0,8 \alpha \varphi_{b,cr}\sigma_{bpj}}{1 + \alpha \mu_{spj}\le ft(1 + \frac{y_{sj}^2 A_{red}}{I_{red}}\right)(1 + 0,8 \varphi_{b,cr})} \tag{216}$$
...
$$P_{(1)} = \sum_{j} \le ft( A_{spj} \sigma_{sp(1)j} \right) \tag{218}$$
...
$$P_{(2)} = \sum_{j} \le ft( A_{spj} \sigma_{sp(2)j} \right) \tag{220}$$
...
<!-- DIAGRAM: word/media/image207.png -->
...
$$N_p \le q R_b b_f' h_f' - R_s A_s + R_{sc} A_s' \tag{229}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_229" -->
...
$$\begin{aligned}
M_x &= \sum_i \sigma_{bi} A_{bi} Z_{bxi} + \sum_j \sigma_{sj} A_{sj} Z_{sxj} + \sum_i \sigma_{s'i} A_{s'i} Z_{s'xi} \tag{233} \\
M_y &= \sum_i \sigma_{bi} A_{bi} Z_{byi} + \sum_j \sigma_{sj} A_{sj} Z_{syj} + \sum_i \sigma_{s'i} A_{s'i} Z_{s'yi} \tag{234} \\
N &= \sum_i \sigma_{bi} A_{bi} + \sum_j \sigma_{sj} A_{sj} + \sum_i \sigma_{s'i} A_{s'i} \tag{235}
\end{aligned}$$
...
$$\sigma_{si} = E_{si} \gamma_{si} \le ft( \varepsilon_{si} + \varepsilon_{spi} \right) \tag{241}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_241" -->


<!-- DIAGRAM: word/media/image218.png -->
...
$$\sigma_s = \le ft[ \frac{M_p (h_0 - y_c)}{I_{red}} - \frac{N_p}{A_{red}} \right] \frac{E_s}{E_b}$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_166" -->
...
<!-- DIAGRAM: word/media/image226.png -->
...
Chiều cao vùng chịu nén được xác định như đối với cấu kiện không ứng suất trước chịu uốn theo 8 2.3.3.6 nhưng trong đó giá trị µ$_{s}$ được nhân với $1 + \frac{N_\rho}{M_\rho} z$.
...
$$\sigma_{si} = \le ft( \frac{E_{si} \varepsilon_{si}}{\psi_{si}} + E_{si}\varepsilon_{0si} \right)$$
<!-- formula_id: "F_TCVN_5574_2018_FORMULA_244" -->
...
Đối với các giá trị độ mảnh trung gian của cấu kiện thì giá trị µ$_{s}$ được xác định bằng nội suy tuyến tính.
...
&nbsp;&nbsp;\- Trong các cấu kiện chịu nén lệch tâm về phía các biên, nơi mà xuất hiện ứng suất kéo; khi đó, hàm lượng cốt thép µ$_{s}$ lấy không nhỏ hơn 0,025 %.
...
Số lượng các thanh cốt thép (có gân) chịu kéo hoặc chịu nén được nối trong một tiết diện cấu kiện bằng các mối nối cơ khí cho phép lấy bằng 100 % khi hàm lượng cốt thép dọc µ$_{s}$ ≤ 3% và không lớn hơn 50 % trong các trường hợp còn lại. Khoảng cách giữa các tiết diện của cốt thép được nối lấy bằng chiều dài đoạn nối chồng $L_{lap}$ (xem công thức (259)).
...
<!-- DIAGRAM: word/media/image239.png -->
...
<!-- DIAGRAM: word/media/image240.png -->
