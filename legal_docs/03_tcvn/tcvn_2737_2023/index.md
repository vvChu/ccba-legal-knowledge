...
- [Cây Cú Pháp Điều Khoản (AST Clauses JSON)](./clauses.json) — 209 nodes điều khoản phục vụ AI QC & RAG.
- [Bộ Đánh Giá Độ Chính Xác (QA Benchmark)](./qa_benchmark.json) — 209 cặp câu hỏi - câu trả lời đối soát.
