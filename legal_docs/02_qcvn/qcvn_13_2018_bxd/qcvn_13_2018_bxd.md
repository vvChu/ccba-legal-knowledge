...
<a id="muc-2-1-9"></a>
### 2.1.9  Ô-tô vận chuyển các nhiên liệu và chất bôi trơn chỉ được phép lưu giữ trên các bãi hở hoặc trong các nhà một tầng đứng riêng biệt có bậc chịu lửa không nhỏ hơn bậc II thuộc cấp S0. Cho phép các gara ô-tô trên được bố trí liền kề với các tường đặc ngăn cháy loại 1 hoặc 2 của các nhà sản xuất có bậc chịu lửa I, II thuộc cấp S0 (ngoại trừ các nhà hạng nguy hiểm cháy và cháy nổ A và B) khi lưu giữ ô-tô có tổng dung tích chứa nhiên liệu và chất bôi trơn không quá 30 $m^{3}$.

Trên các bãi hở, việc lưu giữ ô-tô chở nhiên liệu và chất bôi trơn phải chia theo nhóm với số lượng không quá 50 xe và tổng dung tích chứa các chất nêu trên không quá 600 $m^{3}$. Khoảng cách giữa các nhóm xe này, cũng như khoảng cách tới các khu đất lưu giữ các loại xe khác không được nhỏ hơn 12 m.
...
| Tổng dung tích các chất lỏng dễ cháy, $m^{3}$ | Khoảng cách từ gara ô-tô tới nhà và công trình và khoảng cách giữa các gara ô-tô, m — Nhà và bậc chịu lửa — I, II | Khoảng cách từ gara ô-tô tới nhà và công trình và khoảng cách giữa các gara ô-tô, m — Nhà và bậc chịu lửa — III | Khoảng cách từ gara ô-tô tới nhà và công trình và khoảng cách giữa các gara ô-tô, m — Nhà và bậc chịu lửa — IV, V |
| :--- | :--- | :--- | :--- |
| (1) | (2) | (3) | (4) |
...
| Loại gara ô-tô | Giới hạn chịu lửa của các kết cấu bao che (các vách ngăn cháy), phút, không nhỏ hơn — Tường | Giới hạn chịu lửa của các kết cấu bao che (các vách ngăn cháy), phút, không nhỏ hơn — Cổng | Yêu cầu bố trí khoang đệm |
| :--- | :--- | :--- | :--- |
...
Trong các nhà chiều cao không quá 3 tầng có bậc chịu lửa bậc I và II thuộc cấp S0 và S1 và tổng diện tích các tầng (các tầng lửng), được nối với nhau bằng các đường dốc không cách ly, không vượt quá 10.400 $m^{2}$;
...
| Loại gara ô-tô | Khoảng cách đến lối thoát hiểm gần nhất, khi bố trí chỗ lưu giữ xe (m) — Giữa các lối thoát hiểm | Khoảng cách đến lối thoát hiểm gần nhất, khi bố trí chỗ lưu giữ xe (m) — Tại phần cụt của gian phòng |
| :--- | :---: | :---: |
| Ngầm | 40 | 20 |
| Trên mặt đất | 60 | 25 |
...
| Bậc chịu lửa của nhà (công trình) | Cấp nguy hiểm cháy kết cấu của nhà<br>(công trình) | Số tầng ngầm tối đa cho phép | Diện tích cho phép lớn nhất của một tầng trong phạm vi một khoang cháy, $m^{2}$ |
| :--- | :--- | :---: | :---: |
| I | S0 | 5 | 3.000 |
| II | S0 | 3 | 3.000 |
...
| Bậc chịu lửa của nhà (công trình) | Cấp nguy hiểm cháy kết cấu của nhà (công trình) | Số tầng tối đa cho phép | Diện tích cho phép lớn nhất của một tầng trong phạm vi một khoang cháy, $m^{2}$ — Nhà một tầng | Diện tích cho phép lớn nhất của một tầng trong phạm vi một khoang cháy, $m^{2}$ — Nhà nhiều tầng |
| :--- | :--- | :---: | :---: | :---: |
...
| Bậc chịu lửa của nhà (công trình) | Cấp nguy hiểm cháy kết cấu của nhà (công trình) | Số tầng tối đa cho phép | Diện tích cho phép lớn nhất của một tầng trong phạm vi một khoang cháy, m2 — Nhà một tầng | Diện tích cho phép lớn nhất của một tầng trong phạm vi một khoang cháy, m2 — Nhà nhiều tầng |
| :--- | :--- | :---: | :---: | :---: |
| I, II | S0 | 9 | 10.400 | 5.200 |
|  | S1 | 2 | 3.500 | 2.000 |
...
Trong các gara ô-tô ngầm cho phép nối các vùng khói có diện tích không quá 900 $m^{2}$ ở từng tầng hầm tới một giếng khói.
...
Trong các hệ thống thông gió chống khói hút các van chống cháy (kể cả van khói) phải có sức cản thẩm thấu khí khói không nhỏ hơn 8000 $KG^{-1}$.$m^{-1}$ cho 1 $m^{2}$ diện tích tiết diện đi qua.
...
c) \- Gara ô-tô trên mặt đất 1 tầng có bậc chịu lửa bậc I, II và III với diện tích 7000 $m^{2}$ trở lên, bậc chịu lửa bậc IV, cấp S0 có diện tích 3600 $m^{2}$ trở lên, bậc chịu lửa bậc IV, cấp S1 - 2000 $m^{2}$ trở lên, bậc chịu lửa bậc IV làm từ vật liệu không thuộc hai cấp S2, S3 - 1000 $m^{2}$ trở lên; khi lưu giữ ô-tô trong các ngăn chứa riêng (theo 2.2.1.4) trong các nhà này - với số lượng ngăn lớn hơn 5;
...
| TT | Đặc trưng của các hệ thống báo cháy | Loại của hệ thống báo cháy — 1 | Loại của hệ thống báo cháy — 2 | Loại của hệ thống báo cháy — 3 | Loại của hệ thống báo cháy — 4 | Loại của hệ thống báo cháy — 5 |
| :---: | :--- | :--- | :--- | :--- | :--- | :--- |
| 1 | Các biện pháp báo cháy: |  |  |  |  |  |
| 1 | Tín hiệu âm thanh (chuông, còi hú....) | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ | * | * | * |
| 1 | Giọng nói (băng ghi âm và truyền thanh) | - | - | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
| 1 | Đèn hiệu |  |  |  |  |  |
| 1 | nhấp nháy | * | * | - | - | - |
| 1 | đèn hiệu “lối ra” | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
| 1 | Đèn hiệu dẫn hướng chuyển động | - | * | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
| 1 | Đèn hiệu dẫn hướng chuyển động cho từng vùng | - | * | * | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
| 2 | Liên lạc vùng báo cháy với bộ phận điều độ | - | - | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
| 3 | Trình tự báo cháy: |  |  |  |  |  |
| 3 | Tất cả đồng thời | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ | - | - | - |
| 3 | Chỉ trong một gian phòng (trong một phần của nhà) | * | * | * | - | - |
| 3 | trước tiên của nhân viên phục vụ, sau đó của tất cả theo trình tự được thiết lập riêng | - | * | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ | &nbsp;&nbsp;&nbsp;&nbsp;\+ |
...
| :---: | :--- | :---: | :---: |
| **Phụ lục A** | Quy định về kích thước bố trí gara ô-tô | Quy định | [📑 **Xem Phụ lục**](annexes/phu_luc_a_quy_dinh_ve_kich_thuoc_bo_tri_gara_o_to.md#phu-luc-a) |
