...
Toàn bộ 9 Phụ lục kỹ thuật chuyên đề đã được module hóa thành các tệp độc lập nhằm tối ưu hóa tra cứu và thẩm tra thiết kế:
Toàn bộ 9 Phụ lục kỹ thuật chuyên đề đã được module hóa thành các tệp độc lập nhằm tối ưu hóa tra cứu và thẩm tra thiết kế:

- [📑 **PHỤ LỤC A:** Quy định bổ sung đối với một số nhóm nhà cụ thể](annexes/phu_luc_a_quy_dinh_bo_sung_nhom_nha_cu_the.md#phu-luc-a)
- [📑 **PHỤ LỤC B:** Phân loại vật liệu xây dựng theo đặc tính kỹ thuật về cháy](annexes/phu_luc_b_phan_loai_vat_lieu_xay_dung.md#phu-luc-b)
- [📑 **PHỤ LỤC C:** Hạng nguy hiểm cháy và cháy nổ của nhà, công trình và gian phòng](annexes/phu_luc_c_hang_nguy_hiem_chay_va_chay_no.md#phu-luc-c)
- [📑 **PHỤ LỤC D:** Bảo vệ chống khói (Hệ thống hút khói và cấp khí bù)](annexes/phu_luc_d_bao_ve_chong_khoi.md#phu-luc-d)
- [📑 **PHỤ LỤC E:** Khoảng cách phòng cháy chống cháy](annexes/phu_luc_e_khoang_cach_pccc.md#phu-luc-e)
- [📑 **PHỤ LỤC F:** Giới hạn chịu lửa danh định của một số cấu kiện](annexes/phu_luc_f_gioi_han_chiu_lua_danh_dinh.md#phu-luc-f)
- [📑 **PHỤ LỤC G:** Khoảng cách đến lối ra thoát nạn và chiều rộng lối thoát nạn](annexes/phu_luc_g_khoang_cach_va_chieu_rong_thoat_nan.md#phu-luc-g)
- [📑 **PHỤ LỤC H:** Bậc chịu lửa và các yêu cầu an toàn cháy cho nhà, công trình, khoang cháy](annexes/phu_luc_h_bac_chiu_lua_va_khoang_chay.md#phu-luc-h)
- [📑 **PHỤ LỤC I:** Các hình minh họa cấu tạo buồng thang và thoát nạn](annexes/phu_luc_i_hinh_minh_hoa.md#phu-luc-i)

---

## TRA CỨU 64 BẢNG SỐ LIỆU KỸ THUẬT 2D (TABLES)

Tra cứu 64 bảng số liệu chi tiết dạng CSV/JSON tại [Thư mục Bảng Số Liệu](tables/README.md).