...
#### <a id="sd1-muc-1-1-10" name="sd1-muc-1-1-10"></a>Sửa đổi điểm 1.1.10 như sau:
...
#### <a id="sd1-muc-1-1-11" name="sd1-muc-1-1-11"></a>Bổ sung điểm 1.1.11 như sau:
...
#### <a id="sd1-muc-1-5-5" name="sd1-muc-1-5-5"></a>Bổ sung điểm 1.5.5 như sau:
...
#### <a id="sd1-muc-1-5-6" name="sd1-muc-1-5-6"></a>Bổ sung điểm 1.5.6 như sau:
...
### <a id="sd1-chuong-2" name="sd1-chuong-2"></a>2  PHÂN LOẠI KỸ THUẬT VỀ CHÁY

#### <a id="sd1-muc-2-3-2-2" name="sd1-muc-2-3-2-2"></a>Sửa đổi CHÚ THÍCH tại 2.3.2.2 như sau:
...
#### <a id="sd1-muc-3-4-13" name="sd1-muc-3-4-13"></a>Sửa đổi điểm 3.4.13 như sau:
...
#### <a id="sd1-muc-3-4-14" name="sd1-muc-3-4-14"></a>Sửa đổi điểm 3.4.14 như sau:

- Bổ sung cụm từ vào cuối điểm 3.4.14 như sau: “theo yêu cầu của Phụ lục D”.

#### <a id="sd1-muc-3-5-10" name="sd1-muc-3-5-10"></a>Sửa đổi điểm 3.5.10 như sau:
...
#### <a id="sd1-muc-4-23" name="sd1-muc-4-23"></a>Sửa đổi, bổ sung điểm 4.23 như sau:
...
#### <a id="sd1-muc-4-27" name="sd1-muc-4-27"></a>Sửa đổi điểm 4.27 như sau:
...
#### <a id="sd1-muc-4-31" name="sd1-muc-4-31"></a>Sửa đổi điểm 4.31 như sau:

- Thay cụm từ “TCVN 3890” bằng cụm từ “tài liệu chuẩn”.

#### <a id="sd1-muc-4-32-2" name="sd1-muc-4-32-2"></a>Sửa đổi, bổ sung điểm 4.32.2 như sau:

“4.32.2 Cho phép không áp dụng các quy định tại 4.32.1 nếu nhà được trang bị chữa cháy tự động.”.

#### <a id="sd1-muc-4-33-3" name="sd1-muc-4-33-3"></a>Sửa đổi, bổ sung điểm 4.33.3 như sau:

- Bổ sung cụm từ “như quy định tại đoạn c) điểm 4.33.1” vào cuối điểm 4.33.3.

#### <a id="sd1-muc-4-33-4" name="sd1-muc-4-33-4"></a>Sửa đổi điểm 4.33.4 như sau:
...
#### <a id="sd1-muc-4-34" name="sd1-muc-4-34"></a>Sửa đổi điểm 4.34 như sau:
...
#### <a id="sd1-muc-5-1-5-10" name="sd1-muc-5-1-5-10"></a>Sửa đổi điểm 5.1.5.10 như sau:
...
#### <a id="sd1-muc-6-12" name="sd1-muc-6-12"></a>Sửa đổi điểm 6.12 như sau:
...
#### <a id="sd1-muc-a-1-2-1" name="sd1-muc-a-1-2-1"></a>Sửa đổi điểm A.1.2.1 như sau:
...
#### <a id="sd1-muc-a-1-3-2" name="sd1-muc-a-1-3-2"></a>Bãi bỏ đoạn thứ hai của điểm A.1.3.2.

#### <a id="sd1-muc-a-1-3-6" name="sd1-muc-a-1-3-6"></a>Sửa đổi điểm A.1.3.6 như sau:

- Thay chữ “hạng” bằng chữ “cấp”.

#### <a id="sd1-muc-a-1-3-10" name="sd1-muc-a-1-3-10"></a>Sửa đổi điểm A.1.3.10 như sau:
...
#### <a id="sd1-muc-a-2-11" name="sd1-muc-a-2-11"></a>Sửa đổi, bổ sung điểm A.2.11 như sau:
...
#### <a id="sd1-muc-a-2-12" name="sd1-muc-a-2-12"></a>Sửa đổi, bổ sung điểm A.2.12 như sau:
...
#### <a id="sd1-muc-a-2-14" name="sd1-muc-a-2-14"></a>Sửa đổi, bổ sung điểm A.2.14 như sau:
...
#### <a id="sd1-muc-a-2-20" name="sd1-muc-a-2-20"></a>Sửa đổi, bổ sung điểm A.2.20 như sau:
...
#### <a id="sd1-muc-a-2-25-5" name="sd1-muc-a-2-25-5"></a>Bổ sung điểm A.2.25.5 như sau:

“A.2.25.5 Trường hợp không tuân thủ được các yêu cầu từ A.2.25.1 đến A.2.25.4 thì có thể thực hiện theo 3.5.10.".

#### <a id="sd1-muc-a-3-1-8" name="sd1-muc-a-3-1-8"></a>Sửa đổi điểm A.3.1.8 như sau:

- Bãi bỏ cụm từ “với khoảng cách hở thông thủy giữa các bản thang không nhỏ hơn 100 mm”.

#### <a id="sd1-muc-a-3-1-13" name="sd1-muc-a-3-1-13"></a>Sửa đổi điểm A.3.1.13 như sau:
...
#### <a id="sd1-muc-a-3-2-2" name="sd1-muc-a-3-2-2"></a>Bổ sung điểm A.3.2.2 như sau:
...
#### <a id="sd1-muc-c-3-1" name="sd1-muc-c-3-1"></a>Sửa đổi, bổ sung điểm C.3.1 như sau:
...
### <a id="sd1-phu-luc-d" name="sd1-phu-luc-d"></a>PHỤ LỤC D
...
#### <a id="sd1-muc-d-1-2" name="sd1-muc-d-1-2"></a>Sửa đổi điểm D.1.2 như sau:
...
#### <a id="sd1-muc-d-1-7" name="sd1-muc-d-1-7"></a>Sửa đổi điểm D.1.7 như sau:
...
#### <a id="sd1-muc-d-2" name="sd1-muc-d-2"></a>Sửa đổi, bổ sung điểm D.2 như sau:
...
#### <a id="sd1-muc-d-14-5" name="sd1-muc-d-14-5"></a>Sửa đổi điểm D.14.5 như sau:
...
### <a id="sd1-phu-luc-e" name="sd1-phu-luc-e"></a>PHỤ LỤC E
...
#### <a id="sd1-muc-e-2" name="sd1-muc-e-2"></a>Sửa đổi điểm E.2 như sau:

- Thay cụm từ “trong một cơ sở công nghiệp” bằng cụm từ “sản xuất, nhà kho".

#### <a id="sd1-muc-e-3" name="sd1-muc-e-3"></a>Sửa đổi tiêu đề điểm E.3 như sau:

“E.3 Khoảng cách phòng cháy chống cháy xác định theo đường ranh giới”.

#### <a id="sd1-muc-e-3-1" name="sd1-muc-e-3-1"></a>Sửa đổi, bổ sung điểm E.3.1 như sau:

- Thay cụm từ “để xác định” bằng cụm từ “được xác định tương ứng với”.

#### <a id="sd1-muc-e-3-2" name="sd1-muc-e-3-2"></a>Sửa đổi điểm E.3.2 như sau:
...
### <a id="sd1-phu-luc-g" name="sd1-phu-luc-g"></a>PHỤ LỤC G

(quy định)

KHOẢNG CÁCH ĐẾN CÁC LỐI RA THOÁT NẠN VÀ CHIỀU RỘNG LỐI RA THOÁT NẠN

#### <a id="sd1-muc-g-1-2-1" name="sd1-muc-g-1-2-1"></a>Bãi bỏ CHÚ THÍCH của điểm G.1.2.1.

#### <a id="sd1-bang-g2a" name="sd1-bang-g2a"></a>Sửa đổi Bảng G2a như sau:

- Bãi bỏ chữ “buồng” tại điểm 1 Bảng G2a.

#### <a id="sd1-muc-g-3" name="sd1-muc-g-3"></a>Sửa đổi điểm G.3 như sau:

- Bổ sung vào sau từ “G.9” tại đoạn thứ nhất của G.3 cụm từ sau: ", hoặc xác định theo tài liệu chuẩn khác (ví dụ [5])".

### <a id="sd1-phu-luc-h" name="sd1-phu-luc-h"></a>PHỤ LỤC H
...
#### <a id="sd1-muc-h-2-4-4" name="sd1-muc-h-2-4-4"></a>Sửa đổi điểm H.2.4.4 như sau:
...
#### <a id="sd1-muc-h-2-9-1" name="sd1-muc-h-2-9-1"></a>Sửa đổi, bổ sung điểm H.2.9.1 như sau:
...
#### <a id="sd1-muc-h-2-10-1" name="sd1-muc-h-2-10-1"></a>Sửa đổi, bổ sung điểm H.2.10.1 như sau:
...
#### <a id="sd1-muc-h-2-10-3" name="sd1-muc-h-2-10-3"></a>Bãi bỏ điểm H.2.10.3.

#### <a id="sd1-muc-h-2-11-1" name="sd1-muc-h-2-11-1"></a>Sửa đổi điểm H.2.11.1 như sau:
...
#### <a id="sd1-muc-h-2-12-10" name="sd1-muc-h-2-12-10"></a>Bổ sung điểm H.2.12.10 như sau:
...
#### <a id="sd1-muc-h-4-1" name="sd1-muc-h-4-1"></a>Sửa đổi điểm H.4.1 như sau:
...
#### <a id="sd1-muc-h-5-2" name="sd1-muc-h-5-2"></a>Sửa đổi điểm H.5.2 như sau:
...
#### <a id="sd1-muc-h-7" name="sd1-muc-h-7"></a>Bổ sung điểm H.7 như sau:
...
### <a id="sd1-thu-muc-tai-lieu-tham-khao" name="sd1-thu-muc-tai-lieu-tham-khao"></a>Bổ sung THƯ MỤC TÀI LIỆU THAM KHẢO sau Phụ lục I như sau:
