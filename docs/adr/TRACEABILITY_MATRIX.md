...
| [ADR 0035](0035-tri-tier-google-drive-vault-and-ingestion-2-0.md) | **Tri-Tier Cloud Binary Vault Architecture & Universal Ingestion Pipeline 2.0** | ✅ ACCEPTED | `.agents/skills/ccba-legal-ingest/SKILL.md`<br>`.agents/skills/ccba-legal-intel/SKILL.md`<br>`.agents/skills/notebooklm-connector/SKILL.md`<br>`.agents/skills/tvpl-vip-crawler/SKILL.md`<br>`AGENTS.md`<br>`CONTEXT.md`<br>`.md/knowledge/session_learnings.md` |
...
| [ADR 0039](0039-universal-high-fidelity-diagram-extraction-and-annotation-governance.md) | **Bóc Tách Sơ Đồ Đồ Họa Độ Nét Cao & Bảo Tồn Tuyệt Đối Chú Thích Kẹp Giữa (Universal High-Fidelity Diagram Extraction & Annotation Governance)** | ✅ ACCEPTED | `AGENTS.md`<br>`.md/knowledge/session_learnings.md` |
